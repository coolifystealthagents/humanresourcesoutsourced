    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Institutional bluebook</p>
          <h1>Human Resources Outsourced: a selection dossier for clearer staffing decisions.</h1>
          <p className="lead">A redesigned human resources outsourced guide for companies outsourcing HR admin, recruiting coordination, and employee support. The page now uses a distinct traditional institutional layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>rule lines and numbered briefs</figcaption></figure>
      </div>
    </section>
