...
3. The next verified-absent candidate is employee-records access review. Add one two-sentence contextual handoff through the existing `serviceLink` field only in a separately scoped release.
